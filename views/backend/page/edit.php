...
$id = $_REQUEST['id'];
$html_topic_id = '';
$post = Post::where([['status', '!=', 0], ['type', '=', 'page']])->find($id);
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold text-danger">Sửa Trang đơn</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Trang chủ</a></li>
                        <li class="breadcrumb-item"><a href="?option=page&sort=desc&page=1">Trang đơn</a></li>
                        <li class="breadcrumb-item active">Sửa Trang đơn</li>
                    </ol>
                </div>
            </div>
        </div>
...
<p title="Lưu" class="btn rounded-0 m-0 p-0">
    <img width="20px" height="20px" src="../public/image/icon/diskette.png" alt=""></p>
            ...
            <div class="card-body">
                ...
                <form action="?option=page&cat=process&id=<?=$post->id?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-9">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="area"value="" name="detail" id="area" name="metadesc" class="form-control p-2" placeholder="Chi tiết bài viết"  rows="3"><?=$post->detail?></textarea>
                            </div>
                            <div class="form-group">
