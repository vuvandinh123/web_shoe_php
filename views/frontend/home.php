        ...
        <?php foreach ($list_product as  $values) : ?>
            ...
            <div class="col ">
                <div class="card h-100 border border-0">
                    ...
                    <a class='list_product' href="?option=cart&id=<?=$values->id?>" data-product="<?=$values->id?>"><span class="bag" title="Thêm vào giỏ hàng"><i class="fa-solid fa-bag-shopping"></i></span></a>
                    <div class="card-body">
...
<div class="container mt-3 mb-5 bg-shadow">
    <div class="content_snecker row">
        ...
        <div class="col-md-7 p-5">
            ...
            <a class="fs-2 link-hover" href="?option=product&category=giay-the-thao&page=1">XEM TẤT CẢ <i class="fa-solid fa-chevron-right"></i></a>
        </div>
