...
<div class="container">
    <div class="profile_header">
        <div class="anhbia">
            <img width="100%" height=250px src="public/image/user/<?=$_SESSION['cover_image']?>" alt="">
        ...
        <div class="daidien">
            <img  width="100%" height="100%" src="public/image/user/<?=$_SESSION['image']?>" alt=""  data-bs-toggle="dropdown" aria-expanded="false">
